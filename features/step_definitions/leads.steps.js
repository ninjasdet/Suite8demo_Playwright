...
const LeadsPage = require('../../pageobjects/Leads/LeadsPage.js');
const CreateLeadPage = require('../../pageobjects/Leads/CreateLeadPage.js');
const ImportVCardLeadPage = require('../../pageobjects/Leads/ImportVCardLeadPage.js');
const ImportLeadsPage = require('../../pageobjects/Leads/ImportLeadsPage.js');
const TestData = require('../../utils/data/leadsTestData.json');
const { generateVCard, writeEmptyFile, writeCsvTest } = require('../../pageobjects/helper.js');

setDefaultTimeout(60 * 1000);

function initLeadsPages(thispage) {
...
When('the user uploads a valid file on the Import Leads page', async function () {
    ...
    const newLeadContent = `"${TestData.importfirstname}","${TestData.importlastname}","${TestData.email}","${TestData.mobile}"`;
...
/* -------------------------------
   COMMON VALIDATION FLOW FOR CREATE LEAD FLOW AND IMPORT LEAD FROM VCARD FLOW
-------------------------------- */
